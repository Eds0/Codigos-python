    ...
    if mil == 0:
        if cen == 0:
            if dez == 0:
                ...
                if uni == 0:
                    print(f'O número {c} em romano é:{dez}')
                else:
                    print(f'O número {c} em romano é:{dez}{uni}')
        else:
            if uni == 0 and dez == 0:
                print(f'O número {c} em romano é:{cen}')
            else:
                print(f'O número {c} em romano é:{cen}{dez}{uni}')
    else:
        if cen == 0 and dez == 0 and uni == 0:
            print(f'O número {c} em romano é:{mil}')
        else:
            print(f'O número {c} em romano é:{dez}{cen}{dez}{uni}')